...
static const char __pyx_k_NumPy_dtype_aliases_Use_np_int[] = "NumPy dtype aliases. Use np.int_/np.float64 (not np.int/np.float) for NumPy 1.20+ compatibility.";
/* #### Code section: decls ### */
...
namespace {
  ...
  #endif
  {
      ...
      "_types",
      __pyx_k_NumPy_dtype_aliases_Use_np_int, /* m_doc */
    #if CYTHON_USE_MODULE_STATE
 ...
 * """NumPy dtype aliases. Use np.int_/np.float64 (not np.int/np.float) for NumPy 1.20+ compatibility."""
 * import numpy as np             # <<<<<<<<<<<<<<
 * FLOAT = np.float64
 * INT = np.int_
*/
 ...
 * INDEX = np.intp
*/
  __Pyx_GetModuleGlobalName(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_float64); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_FLOAT, __pyx_t_3) < (0)) __PYX_ERR(0, 3, __pyx_L1_error)
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_int); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_INT, __pyx_t_2) < (0)) __PYX_ERR(0, 4, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_mstate_global->__pyx_n_u_intp); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_INDEX, __pyx_t_3) < (0)) __PYX_ERR(0, 5, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
...
*/
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_mstate_global->__pyx_n_u_uint8); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_BOOL, __pyx_t_2) < (0)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 6; } index[] = {{1},{39},{34},{4},{5},{5},{3},{18},{7},{4},{4},{8},{10},{8},{2},{5},{12},{10},{8},{5}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (176 bytes) */
const char* const cstring = "BZh91AY&SYm<\340\254\000\000\007\337\200@\000@\001\005@\267%\204@\277o\376  \000\204\022\251\204\365&\321\r=C\315H\006\320\324\032'\241D\323\324\320\362 \0000\211\235\177\031\215<\020\334\306M\224e5I\251k\247;\327\251f\231Q\221fB\215jX#6\367\364\326\250S\313\355\272\032\013\200\343\036\010my\206\256>]Z\020\335\347!\3438\333\307#\264\320J(\301\324\214\240\024\306@\354\224*g>\212\036\263\014\032\254\202\323\206\"\365\rSc\335\201x\207\212\210}\027\225\223\244!\2755\027rE8P\220m<\340\254";
    PyObject *data = __Pyx_DecompressString(cstring, 176, 2);
...
const char* const cstring = "x\332eN1\016\3020\014\374J^\320\t!6\004\002\244JU\273t`\263L\342\210\2108\t\2513\364\367\030X\220\360`\237\356N\276\333\247\306e\355\300\346J\035\267(\001k\305\325x\014\221\234\221l\002\227\\\345\327\326\030\345\376\3478N\323p\031\246\303\334\217\247\363\265\037g\033C\"\010\t\244\242\245\033\332\207\217\031e\273\tI\224\226\002\300\250\262\016g\327\"\275QB\326\233\312'\017\340\3310~\251\205\304\221Gm\010 \264\350n\372c\367\002~QJ\037";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #else /* compression: none (192 bytes) */
const char* const bytes = "?numpy._core.multiarray failed to importnumpy._core.umath failed to importBOOLFLOATINDEXINTcline_in_tracebackfloat64int_intp__main____module____name__npnumpy__qualname__setdefault__test__uint8";
    PyObject *data = NULL;
